...
type Props = {
  email: string;
  topics: Topic[];
  capLevels: CapabilityLevel[];
  userAnswers: AnswerEntry[];
};

export default function ResultsPage({ email, topics, capLevels, userAnswers }: Props) {
  ...
  return (
    <div className={styles.container}>
      ...
      <h3 className={styles.subtitle}>
        Save your company's priority by checking the box/boxes and clicking Save priorities
      </h3>
